...
public class AddMatchListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Add Match List");
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new com.shashank.sony.fancydialoglib.FancyAlertDialog.Builder(AddMatchListActivity.this)
                        .setTitle("Reset Form !")
        ...
        etstat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(AddMatchListActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void loadSpinHome() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(AddMatchListActivity.this,android.R.layout.simple_spinner_item,spinnHomeList);
    ...
    private void loadSpinAway() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(AddMatchListActivity.this,android.R.layout.simple_spinner_item,spinnAwayList);
        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private void cekMatch() {
        ...
        String tanggalpertandingan = ettanggalpertandigan.getText().toString();
        ...
        if (home == away){
            Toast.makeText(getApplicationContext(),"Team Tidak Boleh Sama Harus Beda kecuali Untuk Latihan ", Toast.LENGTH_LONG).show();
        }
        ...
        if (namapertandingan.equals("") || tanggalpertandingan.equals("") || mulai.equals("")||
            ...
            db.insertMatch(namapertandingan,idtournamentx,idteam1,idteam2,tanggalpertandingan,mulai,akhir);
            Toast.makeText(getApplicationContext(),"Sukses Tambah Match ", Toast.LENGTH_LONG).show();
            Intent i = new Intent(getApplicationContext(), MatchListActivity.class);
            i.putExtra("id",idtournamentx);
            i.putExtra("namatournament",namatournamentx);
            startActivity(i);
