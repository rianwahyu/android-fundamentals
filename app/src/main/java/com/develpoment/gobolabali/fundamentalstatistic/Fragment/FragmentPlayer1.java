...
public class FragmentPlayer1 extends Fragment {

    String idteam, idtournament, idmatch1, poss;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        idteam = bundle.getString("welcome");
        idtournament = bundle.getString("idtournament");
        idmatch1 = bundle.getString("idmatch");
        poss = bundle.getString("pos");
...
//        recyclerView.setAdapter(adapterTeam);
        ...
        ArrayList<HashMap<String,String>> row = db.getAllPlayerMatchforUpdate(Integer.parseInt(idteam));
...
//                    Integer.parseInt(idplayer),posisi,nopunggung, nickname);
            ...
            db.updatePlayerMatch(Integer.parseInt(idmatchplayer), Integer.parseInt(idteam), Integer.parseInt(idplayer), Integer.parseInt(idmatch1));

        }

        ArrayList<HashMap<String,String>> rows = db.getAllPlayerMatch(Integer.parseInt(idmatch1),Integer.parseInt(idteam));
    ...
    public class AdapterPlayerList extends RecyclerView.Adapter<SimpleViewHolder> {
        ...
        public void onBindViewHolder(final SimpleViewHolder holder, int position) {
            ...
            holder.textNama.setText(nickname);
            ...
            if (status.equals("2")){
                holder.textLineUp.setVisibility(View.GONE);
                holder.textPosisi.setVisibility(View.GONE);
                holder.textNama.setVisibility(View.GONE);
                    ...
                    if (status.equals("0")){
                        ...
                        dialog.setItems(dialogitem, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                switch (i){
                                    case 0:
                                        db.updatestatusplayermatch(Integer.parseInt(idmatch1),Integer.parseInt(idteam),Integer.parseInt(idplayer));
                                        holder.textLineUp.setText("YA");
                        ...
                        dialog.setItems(dialogitem, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                switch (i){
                                    case 0:
                                        db.updatestatusplayermatchNon(Integer.parseInt(idmatch1),Integer.parseInt(idteam),Integer.parseInt(idplayer));
                                        holder.textLineUp.setText("TIDAK");
